...
export default class Myattendance extends Component {
    ...
    render() {
     if(this.state.v){
      ...
      if(this.state.Error){
       return ( <div>
<NavBar/>        <h2 style={{marginTop:'100px'}}>{this.state.Error}</h2>
      <div >
    <Form.Group>
...
{this.state.Message}
        ...
        return (
           <div>
          <NavBar home="/HR" profile="/profile" attendance="/Myattendance"  signin="/MySignInHR" signout="/MySignOutHR" reset="/passwordHR"/>
      <div className="table">
