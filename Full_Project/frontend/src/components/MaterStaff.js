...
<NavBarStaff/>              <Container>
            <Form className="form">
  <Form.Group>
    <Form.Label>Specify Number of Leave Days </Form.Label>
    <Form.Control  placeholder="35" onChange={this.changeDate}/>
  </Form.Group>
  <Form.Group>
    <Form.Label>Document</Form.Label>
    <Form.Control  placeholder="PDF Link" onChange={this.changeDoc}/>
