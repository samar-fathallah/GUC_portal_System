...
export default class updatecourse extends Component {
    ...
    render() {
        return (
            <div>
      <NavBarStaff home="/Head" profile="/profileHOD" attendance="/MyattendanceHOD" signin="/MySignInHOD" signout="/MySignOutHOD" reset="/passwordHOD" schedule="/MyScheduleHOD" request="/MyRequestsHOD"/>
            <Container>
            <Form className="form">
  <Form.Group>
