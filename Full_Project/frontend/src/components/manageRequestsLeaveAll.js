...
export default class manageRequestsLeaveAll extends Component{
    ...
    componentDidMount () {
            axios.get('/HOD/viewrequests/allstaffleave/', {
              params: {
   ...
   {this.state.message2}
                 ...
                 <td className='opration'>
                        <button  style={{backgroundColor:'#0b1b3f'}}  onClick={() => this.accept(values._id)}>accept</button></td>
                        
                       
                        <td className='opration'>
                        <button  style={{backgroundColor:'#0b1b3f'}} onClick={() => this.reject(values._id)}>reject</button></td>
                        <td>
                        <Form>
